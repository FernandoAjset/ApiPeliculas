...
namespace Peliculas.Entidades.Seeding
{
    public static class SeedingModuloConsulta
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            var agoraCineOferta = new CineOferta { Id = 1, CineId = agora.Id, FechaInicio = new DateTime(2022, 3, 10), FechaFin = DateTime.Today.AddDays(7), PorcentajeDescuento = 10 };

            var salaDeCine2DAgora = new SalaDeCine()
            {
                Id = 1,
                CineIdentificador = agora.Id,
                Precio = 220,
            ...
            {
                Id = 5,
                CineIdentificador = megacentro.Id,
                Precio = 250,
                TipoSalaDeCine = TipoSalaDeCine.DosDimensiones
            };
            ...
            {
                Id = 8,
                CineIdentificador = acropolis.Id,
                Precio = 250,
                TipoSalaDeCine = TipoSalaDeCine.DosDimensiones
            };

            var acropolisCineOferta = new CineOferta { Id = 2, CineId = acropolis.Id, FechaInicio = new DateTime(2022,3,1), FechaFin = DateTime.Today.AddDays(5), PorcentajeDescuento = 15 };
            ...
            var theMatrixResurrections = new Pelicula()
            {
                ...
                EnCartelera = true,
                FechaEstreno = new DateTime(2021, 10, 22),
