...
namespace Peliculas.Migraciones
{
    ...
    [Migration("20220324155638_DatosFacturasEjemplo")]
    partial class DatosFacturasEjemplo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Peliculas.Entidades.CineDetalle", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Peliculas.Entidades.CineOferta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 2,
                            CineId = 4,
                            FechaFin = new DateTime(2022, 3, 29, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaInicio = new DateTime(2022, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 1,
                            CineId = 1,
                            FechaFin = new DateTime(2022, 3, 31, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaInicio = new DateTime(2022, 3, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PorcentajeDescuento = 10m
                        });
                });

            modelBuilder.Entity("Peliculas.Entidades.Factura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 4,
                            FechaCreacion = new DateTime(2022, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 5,
                            FechaCreacion = new DateTime(2022, 2, 3, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 6,
                            FechaCreacion = new DateTime(2022, 1, 5, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });

            modelBuilder.Entity("Peliculas.Entidades.FacturaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Peliculas.Entidades.Log", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Peliculas.Entidades.Pago", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Peliculas.Entidades.Pelicula", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 5,
                            EnCartelera = true,
                            FechaEstreno = new DateTime(2021, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Peliculas.Entidades.Producto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Peliculas.Entidades.SalaDeCine", b =>
                {
                    ...
                    b.Property<int>("CineIdentificador")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Peliculas.Entidades.SinLlave.CineSinUbicacion", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Peliculas.Entidades.SinLlave.PeliculasConConteos", b =>
                {
            ...
            modelBuilder.Entity("Peliculas.Entidades.Merchandising", b =>
                {
                    b.HasBaseType("Peliculas.Entidades.Producto");
            ...
            modelBuilder.Entity("Peliculas.Entidades.PagoPaypal", b =>
                {
                    b.HasBaseType("Peliculas.Entidades.Pago");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 5,
                            FechaTransaccion = new DateTime(2022, 1, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Monto = 120m,
                            TipoPago = 1,
            ...
            modelBuilder.Entity("Peliculas.Entidades.PagoTarjeta", b =>
                {
                    b.HasBaseType("Peliculas.Entidades.Pago");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 8,
                            FechaTransaccion = new DateTime(2022, 2, 7, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Monto = 150m,
                            TipoPago = 2,
                            UltimosDigitos = "0123"
                        },
                        ...
                        {
                            Id = 15,
                            FechaTransaccion = new DateTime(2022, 2, 8, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Monto = 120m,
                            TipoPago = 2,
                            UltimosDigitos = "2468"
                        });
            ...
            modelBuilder.Entity("Peliculas.Entidades.PeliculaAlquilable", b =>
                {
                    b.HasBaseType("Peliculas.Entidades.Producto");
            ...
            modelBuilder.Entity("Peliculas.Entidades.Actor", b =>
                {
                    b.OwnsOne("Peliculas.Entidades.Direccion", "Direccion", b1 =>
                        {
            ...
            modelBuilder.Entity("Peliculas.Entidades.CineDetalle", b =>
                {
                    b.HasOne("Peliculas.Entidades.Cine", "Cine")
                        .WithOne("CineDetalle")
                        .HasForeignKey("Peliculas.Entidades.CineDetalle", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Peliculas.Entidades.FacturaDetalle", b =>
                {
                    b.HasOne("Peliculas.Entidades.Factura", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Peliculas.Entidades.SalaDeCine", b =>
                {
                    b.HasOne("Peliculas.Entidades.Cine", "Cine")
                        ...
                        .HasForeignKey("CineIdentificador")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PeliculaSalaDeCine", b =>
                {
                    ...
                    b.HasOne("Peliculas.Entidades.SalaDeCine", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Peliculas.Entidades.Merchandising", b =>
                {
                    b.HasOne("Peliculas.Entidades.Producto", null)
                        .WithOne()
                        .HasForeignKey("Peliculas.Entidades.Merchandising", "Id")
            ...
            modelBuilder.Entity("Peliculas.Entidades.PeliculaAlquilable", b =>
                {
                    b.HasOne("Peliculas.Entidades.Producto", null)
                        .WithOne()
                        .HasForeignKey("Peliculas.Entidades.PeliculaAlquilable", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
