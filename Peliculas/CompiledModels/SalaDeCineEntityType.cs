    ...
    internal partial class SalaDeCineEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "Peliculas.Entidades.SalaDeCine",
                typeof(SalaDeCine),
                baseEntityType);
            ...
            var cineIdentificador = runtimeEntityType.AddProperty(
                "CineIdentificador",
                typeof(int),
                propertyInfo: typeof(SalaDeCine).GetProperty("CineIdentificador", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(SalaDeCine).GetField("<CineIdentificador>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
            cineIdentificador.AddAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.None);
        ...
        {
            var runtimeForeignKey = declaringEntityType.AddForeignKey(new[] { declaringEntityType.FindProperty("CineIdentificador") },
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.AddAnnotation("Relational:TableName", "SalasDeCines");
