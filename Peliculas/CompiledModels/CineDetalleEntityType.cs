    ...
    internal partial class CineDetalleEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "Peliculas.Entidades.CineDetalle",
                typeof(CineDetalle),
                baseEntityType);
            ...
            var mision = runtimeEntityType.AddProperty(
                "Mision",
                typeof(string),
                propertyInfo: typeof(CineDetalle).GetProperty("Mision", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(CineDetalle).GetField("<Mision>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
            mision.AddAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.None);
