...
{
    public partial class DatosInicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 5, true, new DateTime(2022, 2, 26, 0, 0, 0, 0, DateTimeKind.Local), "https://upload.wikimedia.org/wikipedia/en/5/50/The_Matrix_Resurrections.jpg", "The Matrix Resurrections" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 3, 5, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 2, 26, 0, 0, 0, 0, DateTimeKind.Local), 10m },
                    { 2, 4, new DateTime(2022, 3, 3, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 2, 26, 0, 0, 0, 0, DateTimeKind.Local), 15m }
                });
